...
import { NoteDynamoClientRepository } from "../common/note-dynamoclient-repository";
 ...
 * The PostApp takes the HTTP request body, turns it into a NoteItem and stores it in DynamoDB.
 *
 * @param {Object} event - Input event to the Lambda function
 *
 * @returns {Object} object - Object containing the NoteItem stored.
 *
 */
export const handler = async (
  ...
  const repository = new NoteDynamoClientRepository();
